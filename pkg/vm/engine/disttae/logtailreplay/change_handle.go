...
/*
1. find bat candidata
2. find largest ts
3. window batch

1. handle ts range(in mem, aobj, cnobj)
2. decide next and get ts
3. window batch
*/
func NewBaseHandler(
