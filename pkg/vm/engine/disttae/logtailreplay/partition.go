...
type Partition struct {
	...
	lock  chan struct{}
	state atomic.Pointer[PartitionStateWithTombstoneObject]
...
func NewPartition(
	...
	ret.state.Store(NewPartitionStateWithTombstoneObject(service, false, id))
	return ret
}
...
func (p *Partition) Snapshot() *PartitionStateWithTombstoneObject {
	return p.state.Load()
}
...
func (p *Partition) MutateState() (*PartitionStateWithTombstoneObject, func()) {
